...
//    private ItemGroupMaster itemgroupmaster;
    ...
    @Column(name = "UOM_PUR", nullable=true)
    ...
    @Column(name = "CENTRAL_STOCK", nullable=true)
    private double centralStock;
    
    
    @Column(name = "DIRECT_INDIRECT_TAG", nullable=true)
    private String directIndirectTag;
    
    @Column(name = "SPL_ITEM_TAG", nullable=true)
    private String splItemTag;
    
    
    @Column(name = "ISSUABLE_TAG", nullable=true)
    ...
    @Column(name = "USER_2", nullable=true)
    ...
    @Column(name = "USER_3", nullable=true)
    ...
    @Column(name = "USER_4", nullable=true)
    ...
    @Column(name = "DTL_ITEM_DESC1", nullable=true)
    private String dtlItemDsc1;
    
    
    @Column(name = "DTL_ITEM_DESC2", nullable=true)
    ...
    @Column(name = "LEGACY_ITEM_CODE", nullable=true)
